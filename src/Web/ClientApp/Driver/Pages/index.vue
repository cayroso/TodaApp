                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <i v-if="item.sumWeekEarnings>=item.sumLastWeekEarnings" class="fas fa-fw fa-arrow-up text-success"></i>
                                            <i v-else class="fas fa-fw fa-arrow-down text-danger"></i>
                                        </td>
                                        <td>
                                            {{item.sumTodayEarnings|toCurrency}}
                                            <i v-if="item.sumTodayEarnings>=item.sumYesterdayEarnings" class="fas fa-fw fa-arrow-up text-success"></i>
                                            <i v-else class="fas fa-fw fa-arrow-down text-danger"></i>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            {{item.totalWeekTrips}}
                                            <i v-if="item.totalWeekTrips>=item.totalLastWeekTrips" class="fas fa-fw fa-arrow-up text-success"></i>
                                            <i v-else class="fas fa-fw fa-arrow-down text-danger"></i>
                                        </td>
                                        <td>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive mb-0">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr v-for="(r,index) in item.topRiders">
                                        <td>{{index+1}}</td>
                                        <td>{{r.rider}}</td>
    ...
    export default {
        ...
        methods: {
            async get() {
                ...
                try {
                    await vm.$util.axios.get(`/api/drivers/default/dashboard`)
                        .then(resp => {
                            vm.item = resp.data;
                        });
                } catch (e) {
