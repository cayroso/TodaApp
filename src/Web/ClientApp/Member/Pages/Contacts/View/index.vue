    ...
    <div v-cloak>
        ...
        <div class="card mt-2">
            ...
            <b-collapse v-model="toggles.contactInformation">
                <m-information :item="item" :busy="busy" @updated="get"></m-information>
            </b-collapse>
        </div>
        ...
        <div class="card mt-2">
            ...
            <b-collapse v-model="toggles.workInformation">
                <m-work :item="item" :busy="busy" @updated="get"></m-work>
            </b-collapse>
        </div>
        ...
        <div class="card mt-2">
            ...
            <b-collapse v-model="toggles.attachments">
                <m-attachments :id="item.contactId" :token="item.token" :items="item.attachments" :busy="busy" @updated="get"></m-attachments>
            </b-collapse>
        </div>
        ...
        <div class="card mt-2">
            ...
            <b-collapse v-model="toggles.tasks">
                <m-tasks :item="item" :busy="busy" @updated="get"></m-tasks>
            </b-collapse>
        </div>
